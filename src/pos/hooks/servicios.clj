(ns pos.hooks.servicios
  "Business logic hooks for servicios entity.
...
(defn before-load
  ...
  (println "[INFO] Loading servicios with params:" params)
  params)
...
(defn after-load
  ...
  [rows params]
  (println "[INFO] Loaded" (count rows) "servicios record(s)")
...
(defn after-save
  ...
  (println "[INFO] Servicios saved successfully. ID:" entity-id)
  {:success true})
...
(defn before-delete
  ...
  (println "[INFO] Checking if servicios can be deleted. ID:" entity-id)
  {:success true})
...
(defn after-delete
  ...
  (println "[INFO] Servicios deleted successfully. ID:" entity-id)
  {:success true})
