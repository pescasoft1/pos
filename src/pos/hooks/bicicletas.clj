(ns pos.hooks.bicicletas
  "Business logic hooks for bicicletas entity.
...
(defn before-load
  ...
  (println "[INFO] Loading bicicletas with params:" params)
  params)
...
(defn after-load
  ...
  [rows params]
  (println "[INFO] Loaded" (count rows) "bicicletas record(s)")
...
(defn before-save
  ...
  [params]
  (println "[INFO] Saving bicicletas...")
...
(defn after-save
  ...
  (println "[INFO] Bicicletas saved successfully. ID:" entity-id)
  {:success true})
...
(defn before-delete
  ...
  (println "[INFO] Checking if bicicletas can be deleted. ID:" entity-id)
  {:success true})
...
(defn after-delete
  ...
  (println "[INFO] Bicicletas deleted successfully. ID:" entity-id)
  {:success true})
