(ns pos.hooks.orden_productos
  "Business logic hooks for orden_productos entity.
...
(defn before-load
  ...
  (println "[INFO] Loading orden_productos with params:" params)
  params)
...
(defn after-load
  ...
  [rows params]
  (println "[INFO] Loaded" (count rows) "orden_productos record(s)")
...
(defn before-save
  ...
  [params]
  (println "[INFO] Saving orden_productos...")
...
(defn after-save
  ...
  (println "[INFO] Orden_productos saved successfully. ID:" entity-id)
  {:success true})
...
(defn before-delete
  ...
  (println "[INFO] Checking if orden_productos can be deleted. ID:" entity-id)
  {:success true})
...
(defn after-delete
  ...
  (println "[INFO] Orden_productos deleted successfully. ID:" entity-id)
  {:success true})
