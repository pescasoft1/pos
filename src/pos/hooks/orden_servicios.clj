(ns pos.hooks.orden_servicios
  "Business logic hooks for orden_servicios entity.
...
(defn before-load
  ...
  (println "[INFO] Loading orden_servicios with params:" params)
  params)
...
(defn after-load
  ...
  [rows params]
  (println "[INFO] Loaded" (count rows) "orden_servicios record(s)")
...
(defn before-save
  ...
  [params]
  (println "[INFO] Saving orden_servicios...")
...
(defn after-save
  ...
  (println "[INFO] Orden_servicios saved successfully. ID:" entity-id)
  {:success true})
...
(defn before-delete
  ...
  (println "[INFO] Checking if orden_servicios can be deleted. ID:" entity-id)
  {:success true})
...
(defn after-delete
  ...
  (println "[INFO] Orden_servicios deleted successfully. ID:" entity-id)
  {:success true})
