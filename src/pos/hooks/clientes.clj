(ns pos.hooks.clientes
  "Business logic hooks for clientes entity.
...
(defn before-load
  ...
  (println "[INFO] Loading clientes with params:" params)
  params)
...
(defn after-load
  ...
  [rows params]
  (println "[INFO] Loaded" (count rows) "clientes record(s)")
...
(defn after-save
  ...
  (println "[INFO] Clientes saved successfully. ID:" entity-id)
  {:success true})
...
(defn before-delete
  ...
  (println "[INFO] Checking if clientes can be deleted. ID:" entity-id)
  {:success true})
...
(defn after-delete
  ...
  (println "[INFO] Clientes deleted successfully. ID:" entity-id)
  {:success true})
